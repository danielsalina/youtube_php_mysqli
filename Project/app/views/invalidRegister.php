...
<body>
    ...
    <div class="container w-25 my-5 py-5 border border-info border-2 rounded">
        <h3 class="text-center text-white">Please provide your details correctly</h3>
        <form action="../controllers/registerController.php" method="post" class="mt-5 p-5">
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary w-100"><a class="text-white text-decoration-none" href="../../index.php?page=login">Login</a></button>
        </form>
    </div>
